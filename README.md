...
This repo contains a web demo for the `pathfinding` and `pathfinding-indexed` crates on crates.io:
...
2) Install, test, and run the frontend:
...
frontend using the published `pathfinding` and `pathfinding-indexed` crates.
